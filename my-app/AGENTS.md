# Next.js 16 & TypeScript Project Rules

## 0. Project Setup
- ensure you have to use Node.js command line tool.
- To set up a Next.js project, ensure use command `npx create-next-app@latest .`.
...
- Keep up Tailwind CSS's variable into global.css
- Avoid inline styles.
